...
export default function Navbar() {
  ...
  return (
    <nav
      className={`flex text-l text-black justify-between h-20 border border-teal-400 ml-4 mr-4 mt-4 bg-gradient-to-br ${
    ...
    >
      ...
      <ul className="text-black navBarLinks flex px-8 my-auto gap-3" onClick={handleShowLinks}>
        <li className="navBarItem slideInDown-1 md:border md:border-teal-400 md:rounded">
          <Link className="navBarLink" to="/">
            Accueil
          </Link>
        </li>
        <li className="navBarItem slideInDown-2 md:border md:border-teal-400 md:rounded">
          <Link className="navBarLink" to="/About">
            À propos
          </Link>
        </li>
        <li className="navBarItem slideInDown-3 md:border md:border-teal-400  md:rounded">
          <Link className="navBarLink" to="/Activities">
            Activités
          </Link>
        </li>
        <li className="navBarItem slideInDown-4 md:border md:border-teal-400 md:rounded">
