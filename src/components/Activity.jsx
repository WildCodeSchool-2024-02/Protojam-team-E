...
export default function Activity({activity}) {
    return(
        <div className="w-80 max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <p className="text-gray-700 text-base"> Noté : {activity.rating} /5 ⭐</p> </div>
        <div className="px-6 pt-4 pb-2">
            ...
            <NavLink to= {`/activities/${activity.id}`} className="border p-2 rounded-lg bg-green-700 text-white mx-auto"> Details </NavLink>
            </div>  
        </div>
    );
}